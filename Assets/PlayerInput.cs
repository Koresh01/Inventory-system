...
public partial class @PlayerInput: IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": []
        ...
        m_FirstPersonView_MoveDelta = m_FirstPersonView.FindAction("MoveDelta", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_FirstPersonView_MoveDelta;
    public struct FirstPersonViewActions
    {
        private @PlayerInput m_Wrapper;
        public FirstPersonViewActions(@PlayerInput wrapper) { m_Wrapper = wrapper; }
        public InputAction @MoveDelta => m_Wrapper.m_FirstPersonView_MoveDelta;
